...
<div class="body-content animated fadeIn body-content-flex vendor-page">   
            ...
            <form id="vendor_invoice_list" class="h-100 d-flex flex-column flex-no-wrap" action="<?php echo base_url().'vendor/getVendorInvoiceList';?>" name="vendor_invoice_list" method="POST">
            <!--Filter head start -->
                        ...
                        <div class="col-md-12">
                                ...
                                <ul class="leadHeader hideBottomLine">
                                    ...
                                    <li class="status">
                                        ...
                                        <select  id="status" name="status" onchange="submitTableForm('', 1);"  class="form-control input-sm perPage">
                                            ...
                                            <option value="2">Pending Amount Verification</option>
                                            <option value="3">Partially Paid</option>
                                            <option value="5">Advance Partially Paid</option>
                                            <option value="6">Advance Paid</option>
                            ...
                            <?php } ?>
                                  <li>
                                    ...
                                    <div class="pull-left">
                                        <label>&nbsp;</label><br>
                                        <a id="auto_a68" onclick="showAjaxModel('Import Invoice','vendor/upload_vendor_invoice/x','','','50%')" class=" btn btn-success btn-slideright" tabindex="0" href="javascript:void(0);"><span>Import Invoice</span></a>
                                    </div>
                                    </li>
                                   <?php }
                                   ?>
                                    <li class="pull-right">
                                      ...
                                      <div class="contactSearch mt-0">
                                            <input id="auto_a72" name="keyword" class="form-control customFilter searchInput ui-autocomplete-input ui-autocomplete-loading" placeholder="Search" type="text" value="" autocomplete="off" onchange="submitTableForm('', 1);" title="Search by Invoice No or PO No">
                        ...
                        <div class="d-flex flex-no-wrap flex-column h-100 p-10 panel pt-0 mb-0">
                                        ...
                                        <div class="table-responsive-new-two vendor-invoice-list">
                                            ...
                                            <thead class="t-header">
                                                <tr>
                                                <th style="width:10%" width='10%' id="company_th" onclick="showOrderBy('Company Name', 'company_th');" class="rmv_cls sorting " >
                                            ...
                                            <?php } ?>
                                                ...
                                                <th width='10%' id="due_date_th" onclick="showOrderBy('Due Date', 'due_date_th');" class="rmv_cls sorting" >
                                                    <a href="javascript:void(0);">Due Date</a>
                                                </th>
                                                <th width='10%' id="paid_amount_th" onclick="showOrderBy('Paid Amount', 'paid_amount_th');" class="rmv_cls sorting" >
                                                    <a href="javascript:void(0);">Paid Amount($)</a>
                                                </th>
                                                <th width='10%' id="due_amount_th" onclick="showOrderBy('Due Amount', 'due_amount_th');" class="rmv_cls sorting" >
                                                    <a href="javascript:void(0);">Due Amount($)</a>
                                                </th>
                                                <?php
                                                 if($user_session_data->code=='super_admin'){
                                                 ?>
                                                 <th width='10%' id="tv_th" onclick="showOrderBy('Transaction Value', 'tv_th');" class="rmv_cls sorting" >
                                                    <a href="javascript:void(0);">Transaction Value</a>
                                                </th>
                                                <?php 
                                            }?>
                                                <th width='10%' id="added_on_th" onclick="showOrderBy('Created On', 'added_on_th');" class="rmv_cls sorting sorting_desc">
                                                    <a href="javascript:void(0);">Created On</a>
                                                </th>
                                                <th width='10%' id="added_by_th" onclick="showOrderBy('Created By', 'added_by_th');" class="rmv_cls sorting">
...
{    
       $('#inv_page').val(pageId);
       var $data = new FormData($('#vendor_invoice_list')[0]);
        $.ajax({
            beforeSend: function(){
                        $("#customLoader").show();
                    },
            type: "POST",
            url: base_url + 'vendor/getVendorInvoiceList',
            cache:false,
            data: $data,
            processData: false,
            contentType: false,
