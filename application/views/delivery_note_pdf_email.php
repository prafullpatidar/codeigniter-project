...
<tr>
  ...
  <h1 style="margin-top:10pt;font-size:24px;text-align:center;color:#4a206a;">Delivery Note</h1>
  </td>
...
<table Cellpadding="5" width="100%" style="table-layout: auto;border-collapse: collapse;">
  <tr>
    ...
    <td valigh="top" width="13%" style="line-height:0.7;border:none;"><strong style="color:#4a206a;"  >Date:</strong></td>
    <td valigh="top" width="37%" style="line-height:0.7;border:none;"><?php echo ConvertDate($dataArr['added_on'],'','d-m-y');?>
</td>
  </tr>
  <tr>
    <td style="line-height:0.7;border:none;"><strong style="color:#4a206a;">Delivery Note No #:</strong></td>
    <td style="line-height:0.7;border:none;" colspan="2"><?php echo $dataArr['note_no'];?></td>
  </tr>
  <tr>
    <td style="line-height:0.7;border:none;"><strong style="color:#4a206a;">Customer ID:</strong></td>
...
<table Cellpadding="5" width="100%">
  <tr>
    ...
    <td width="37%" style="border:none;"><strong>Vessel</strong><br />
...
<table Cellpadding="5" width="100%" style="table-layout: auto;border-collapse: collapse;">
 <tr>
    <td style="border:none;font-weight:bold;" colspan="5" align="center"><?php echo strtoupper($dataArr['requisition_type']);?></td>
  </tr>
  <tr>
    ...
    <td style="border:none;color:#4a206a;"><strong>Remark</strong></td>
  </tr>
   <?php 
   if(!empty($productArr)){
                  foreach ($productArr as $parent => $rows) {
                    foreach($rows as $category => $products){
                     ...
                     for ($i=0; $i <count($products) ; $i++) { 
                       ...
                       $returnArr .= '<td role="gridcell" tabindex="-1" aria-describedby="f2_key">'.ucwords(str_replace('_',' ', $products[$i]['remark'])).'</td>';
                        $returnArr .='</tr>'; 
                     }
                  }
                }
