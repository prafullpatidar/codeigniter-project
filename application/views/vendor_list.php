<?php
 ...
 $add_vendor = checkLabelByTask('add_vendor');
?>
<style>
body{
    overflow: hidden;
...
<div id="tour-11" class="header-content">
  <div class="dt-buttons pull-right" style="margin-top:-5px;">
    <?php if(!empty($checkEditPermission)){ ?>
        <a id="auto_a68" onclick="showAjaxModel('Add Vendor','vendor/add_edit_vendor','','','70%')" class=" btn btn-success btn-slideright" tabindex="0" href="javascript:void(0);"><span>Add New</span></a>
        <?php } ?>
    </div>
  <h2><span class="icon"><i class="fas fa-user-friends"></i></span> <span class="oblc">/</span><?php echo $heading; ?></h2>
  <div class="clr"></div>
</div>
<!-- /.header-content --> 
...
<div class="body-content animated fadeIn body-content-flex">  
            ...
            <form class="h-100 d-flex flex-column flex-no-wrap" id="vendor_list" name="vendor_list" method="POST" action="<?php echo base_url(); ?>vendor/getallvendor">
            <!--Filter head start -->
                                ...
                                <ul class="leadHeader hideBottomLine">
                                    ...
                                    <li class="pull-right">
                                      ...
                                      <div class="contactSearch">
                                            <input id="auto_a72" title="Search by Name, Email, Phone, Address or Country" name="keyword" class="form-control customFilter searchInput ui-autocomplete-input ui-autocomplete-loading" placeholder="Search" type="text" value="" autocomplete="off" onchange="submitTableForm('', 1);">
            ...
            <div class="flex-content mb-10">
                        ...
                        <div class="d-flex flex-column h-100 p-10 panel pt-0">
                                        ...
                                        <thead class="t-header">
                                                <tr>
            <th style="width:3%" width="3%" id="entity_type_th" >
                <a href="javascript:void(0);">Profile</a>
            </th>
            <th width="10%" id="customer_th" onclick="showOrderBy('Customer', 'customer_th');" class="rmv_cls sorting sorting_asc">
            ...
            <th width="10%" id="address_th" onclick="showOrderBy('Address', 'address_th');" class="rmv_cls sorting">
...
{    
        ...
        var $data = new FormData($('#vendor_list')[0]);
        $.ajax({
            beforeSend: function(){
                        $("#customLoader").show();
                    },
