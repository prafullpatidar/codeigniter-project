                                   ...
                                   <li>
                                    ...
                                    ?>
                                     <li>
                                        <div class="pull-left">
                                        <label>&nbsp;</label><br>
                                      <a id="auto_a71" class="btn btn-mini btn-success btn-slideright resetbtn" onclick="showAjaxModel('Import Crew Members','shipping/import_crew_members','<?php echo $ship_id;?>','','')" href="#">Import Crew Members</a>
                                        </div>
                                    </li>
                                 <?php }?>
            ...
            <div class="flex-content mb-10">
                        ...
                        <div class="d-flex flex-column h-100 p-10 panel pt-0 mb-0">
                                        ...
                                        <thead class="t-header">                                          
                                          <tr>
                                          	<th width="15%" style="width:15%" id="type_th" onclick="showOrderBy('Type', 'type_th');" class="rmv_cls sorting">
                                                <a href="javascript:void(0);">Type</a>
                                            </th>
                                            <th width="21%" id="ships_th" onclick="showOrderBy('Date and Time', 'date_th');" class="rmv_cls sorting">
                                                <a href="javascript:void(0);">Date</a>
                                            </th>
                                            <th width="27%" id="code_th" onclick="showOrderBy('Imported By', 'imported_by_th');" class="rmv_cls sorting">
                                                <a href="javascript:void(0);">Imported By</a>
                                            </th>
                                            <th width="21%" id="company_th" class="">
...
{    
        ...
        $.ajax({
            ...
            type: "POST",
            url: base_url + 'shipping/getallCrewEntriesList',
            cache:false,
            data: $data,
            processData: false,
            contentType: false,
