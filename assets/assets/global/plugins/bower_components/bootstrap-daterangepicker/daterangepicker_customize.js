  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.template !== 'string')
            options.template = '<div class="daterangepicker dropdown-menu"><div><a class="cust_start_date btn btn-sm current-datRange">Start</a><a class="cust_end_date btn btn-sm">End</a></div>' +
                '<div class="cust_cal_left calendar left">' +
                ...
                '</div>' +
                '<div style="display:none;" class="cust_cal_right calendar right">' +
                    '<div class="daterangepicker_input">' +
                      '<div class="calendar-time">' +
                        '<div></div>' +
                        '<i class="fa fa-clock-o glyphicon glyphicon-time"></i>' +
        ...
        this.container.find('.applyBtn').html('Done');
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            var dateHtml = (this.locale.format=='MM/DD')?this.locale.monthNames[calendar[1][1].month()]:this.locale.monthNames[calendar[1][1].month()] + calendar[1][1].format(" YYYY");

            if (this.showDropdowns) {
                var currentMonth = calendar[1][1].month();
                var currentYear = calendar[1][1].year();                
                var minYear = (currentYear - 50) || (minDate && minDate.year());
                var maxYear = (currentYear + 25) || (maxDate && maxDate.year());
