		...
		output: function(type, options) {
			...
			if(type == 'datauri') {
				//document.location.href = 'data:application/pdf;base64,' + Base64.encode(buffer);
                                $('<a style="display:none" href="data:application/pdf;base64,' + Base64.encode(buffer)+'" download="download.pdf"><span></span></a>').appendTo(document.body).find('span').trigger("click").parent().remove();
			}
