    ...
    return {
        ...
        handleSidebarResponsive: function () {
            ...
            $('.navbar-minimize a').on('click',function(){
                ...
                if ($.cookie('page_sidebar_minimize') == "undefined" || $.cookie('page_sidebar_minimize') == "not_active" || typeof $.cookie('page_sidebar_minimize') == 'undefined') {
                ...
                // If the cookie was already set to active then remove it
                    ...
                    $.removeCookie('page_sidebar_minimize', { path: '/' });
